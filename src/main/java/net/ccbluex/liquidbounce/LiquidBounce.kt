...
object LiquidBounce {
    ...
    lateinit var mainMenu: Screen
    lateinit var keyBindManager: KeyBindManager

    // Menu Background
    var background: Identifier? = Identifier("fdpclient/background.png")
    ...
    fun initClient() {
        ...
        // Load language
        LanguageManager.switchLanguage(MinecraftClient.getInstance().options.language)
